                ...
                handler: async (response: any) => {
                    ...
                    if (verifyRes.ok) {
                        ...
                        masterTracker('Purchase', {
                            ...
                            content_ids: [targetProduct.sku || targetProduct.id],
                            value: amount,
                            currency: 'INR',
                            num_items: quantity
                        });
                                        ...
                                        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 xl:gap-12 items-start" ref={heroRef}>
                                            ...
                                            <div className="lg:col-span-4 lg:sticky lg:top-24 space-y-6">
                                                ...
                                                <div className="pt-6 border-t border-zinc-100 flex flex-col gap-3">
                                                    ...
                                                    >
                                                        {processing ? 'OPENING SECURE GATEWAY...' : siteSettings?.checkoutMode === 'magic' ? '✨ MAGIC BUY NOW' : 'SECURE BUY NOW'}
                                                    </button>
                                                </div>
