...
const ProductDetailsPage: React.FC<ProductDetailsPageProps> = ({ productId, user, logout, setView }) => {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-gray-50">
      ...
      <main className="flex-grow container mx-auto px-4 py-8">
        <button onClick={() => setView('home')} className="text-gray-500 hover:text-gray-700 mb-6 flex items-center">
           &larr; Back to Shop
        </button>
