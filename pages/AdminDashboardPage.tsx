...
import MarketingAutomations from '../components/admin/marketing/MarketingAutomations';
import MetaAdsApp from '../components/admin/apps/MetaAdsApp';
import GoogleAdsApp from '../components/admin/apps/GoogleAdsApp';
...
const AdminDashboardPage: React.FC<{ user: User; logout: () => void }> = ({ user: initialUser, logout }) => {
    ...
    useEffect(() => {
        ...
        else if (path.includes('/marketing/automations')) setCurrentView('marketing-automations');
        else if (path.includes('/marketing')) setCurrentView('marketing');
        else if (path.includes('/apps/meta')) setCurrentView('app-meta');
        else if (path.includes('/apps/google')) setCurrentView('app-google');
    ...
    const renderContent = () => {
        switch (currentView) {
            ...
            case 'marketing-automations': return <MarketingAutomations token={token} />;
            case 'app-meta': return <MetaAdsApp token={token} />;
            case 'app-google': return <GoogleAdsApp token={token} />;
