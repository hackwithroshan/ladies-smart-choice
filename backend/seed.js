...
const importData = async () => {
  try {
    ...
    await Category.insertMany([
      { id: 'clothing', name: 'Clothing', subcategories: [{ id: 'dresses', name: 'Dresses' }, { id: 'tops', name: 'Tops & Blouses' }] },
      { id: 'footwear', name: 'Footwear', subcategories: [{ id: 'heels', name: 'Heels & Pumps' }, { id: 'flats', name: 'Flats & Sandals' }] },
      { id: 'accessories', name: 'Accessories', subcategories: [{ id: 'bags', name: 'Handbags' }, { id: 'jewelry', name: 'Jewelry' }] },
      { id: 'beauty', name: 'Beauty', subcategories: [{ id: 'makeup', name: 'Makeup' }, { id: 'skincare', name: 'Skincare' }] },
    ]);
