...
// Hardcoded button classes since buttonVariants is not exported from button.tsx
...
const buttonDefault = "bg-primary text-primary-foreground hover:bg-primary/90 shadow-sm"
