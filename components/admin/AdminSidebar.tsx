...
const AdminSidebar: React.FC<AdminSidebarProps> = ({ currentView, setCurrentView, user }) => {
    ...
    const NavItem = ({ icon: Icon, label, view, path, isSubItem = false }: any) => {
        ...
        return (
            <SidebarMenuItem>
                <SidebarMenuButton 
                    isActive={isActive}
                    onClick={() => { setCurrentView(view); navigate(path); }}
                    className={cn(
    ...
    const SubMenuTrigger = ({ icon: Icon, label, subKey }: any) => {
                    ...
                    <SidebarMenu className="space-y-0.5">
                        ...
                        {openSubmenus['products'] && (
                            <div className="space-y-0.5 mb-2">
                                ...
                                <NavItem label="Inventory" view="inventory" path="/app/products" isSubItem />
