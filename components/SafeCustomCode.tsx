...
const SafeCustomCode: React.FC<SafeCustomCodeProps> = ({ 
    ...
    useEffect(() => {
        ...
        if (productContext) {
            contextObj = {
                ...contextObj,
                productId: productContext.id || (productContext as any)._id,
        ...
        // 2. Perform string replacement (The Liquid Engine Simulation)
    ...
    return (
        <div id={`safe-custom-section-${sectionId}`} ref={containerRef} className="w-full relative overflow-visible" />
    );
};
