...
interface IconProps extends React.SVGProps<SVGSVGElement> {
    ...
    // Fix: Explicitly added key property to satisfy TypeScript when icons are used in mapped lists
    key?: React.Key;
}
...
export const EditPencil = (props: IconProps) => (
    <BaseIcon {...props}><path d="M17 3a2.85 2.83 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5Z"/><path d="m15 5 4 4"/></BaseIcon>
);
...
export const Eye = (props: IconProps) => (
    <BaseIcon {...props}><path d="M2 12s3-7 10-7 10 7 10 7-3 7-10 7-10-7-10-7Z"/><circle cx="12" cy="12" r="3"/></BaseIcon>
);
...
// Fix: Added missing icons for Header, Footer and general app use
export const TailGridsLogo = (props: IconProps) => (
  <BaseIcon {...props}><path d="M12 2L2 7l10 5 10-5-10-5zM2 17l10 5 10-5M2 12l10 5 10-5" /></BaseIcon>
);

export const InstagramIcon = (props: IconProps) => (
  <BaseIcon {...props}><rect x="2" y="2" width="20" height="20" rx="5" ry="5"/><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"/><line x1="17.5" y1="6.5" x2="17.51" y2="6.5"/></BaseIcon>
);

export const FacebookIcon = (props: IconProps) => (
  <BaseIcon {...props}><path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"/></BaseIcon>
);

export const YoutubeIcon = (props: IconProps) => (
  <BaseIcon {...props}><path d="M22.54 6.42a2.78 2.78 0 0 0-1.94-2C18.88 4 12 4 12 4s-6.88 0-8.6.42a2.78 2.78 0 0 0-1.94 2C1 8.14 1 12 1 12s0 3.86.42 5.58a2.78 2.78 0 0 0 1.94 2c1.72.42 8.6.42 8.6.42s6.88 0 8.6-.42a2.78 2.78 0 0 0 1.94-2C23 15.86 23 12 23 12s0-3.86-.42-5.58z"/><polygon points="9.75 15.02 15.5 12 9.75 8.98 9.75 15.02"/></BaseIcon>
);

export const XIcon = (props: IconProps) => (
  <BaseIcon {...props}><path d="M4 4l11.733 16h4.267l-11.733 -16z"/><path d="M4 20l6.768 -6.768m2.46 -2.46l6.772 -6.772"/></BaseIcon>
);
...
export const Truck = (props: IconProps) => (
  <BaseIcon {...props}><rect x="1" y="3" width="15" height="13"/><polygon points="16 8 20 8 23 11 23 16 16 16 16 8"/><circle cx="5.5" cy="18.5" r="2.5"/><circle cx="18.5" cy="18.5" r="2.5"/></BaseIcon>
);

export const CreditCard = (props: IconProps) => (
  <BaseIcon {...props}><rect x="1" y="4" width="22" height="16" rx="2" ry="2"/><line x1="1" y1="10" x2="23" y2="10"/></BaseIcon>
);

export const Smartphone = (props: IconProps) => (
  <BaseIcon {...props}><rect x="5" y="2" width="14" height="20" rx="2" ry="2"/><line x1="12" y1="18" x2="12.01" y2="18"/></BaseIcon>
);
...
export const TrendingDown = (props: IconProps) => (
  <BaseIcon {...props}><polyline points="23 18 13.5 8.5 8.5 13.5 1 6"/><polyline points="17 18 23 18 23 12"/></BaseIcon>
);
...
export const Bell = (props: IconProps) => (
  <BaseIcon {...props}><path d="M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9"/><path d="M13.73 21a2 2 0 0 1-3.46 0"/></BaseIcon>
);
...
export const X = (props: IconProps) => (
  <BaseIcon {...props}><path d="M18 6L6 18"/><path d="M6 6l12 12"/></BaseIcon>
);

export const Palette = (props: IconProps) => (
  <BaseIcon {...props}><circle cx="13.5" cy="6.5" r=".5"/><circle cx="17.5" cy="10.5" r=".5"/><circle cx="8.5" cy="7.5" r=".5"/><circle cx="6.5" cy="12.5" r=".5"/><path d="M12 2C6.477 2 2 6.477 2 12c0 4.411 3.589 8 8 8a.999.999 0 0 0 .9-.56l.6-1.2c.16-.32.48-.52.84-.52h.33a4 4 0 0 1 4 4c0 .55.45 1 1 1a8 8 0 0 0 8-8c0-5.523-4.477-10-10-10z"/></BaseIcon>
);
